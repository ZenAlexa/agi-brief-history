...
% Arrow: input -> shared expert (bypass router)
\draw[arrow, figGreen] (input.east) -- ++(8mm, 0) |- (shared.south)
...
\draw[arrow, figBlue] (eN.north) |- (combine.east);

% Arrow: shared -> combine
\draw[arrow, figGreen] (shared.north) |- (combine.east);
