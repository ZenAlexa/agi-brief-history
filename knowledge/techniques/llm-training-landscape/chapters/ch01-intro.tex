...
Google 推出 \textbf{Gemini~3~Pro}（2 月），
...
中国开源模型在 HuggingFace 上的使用占比
已从 2024 年的 1.2\% 攀升至 2026 年初的约 30\%，
标志着全球开源 AI 格局的根本性重构。
...
从 Gemini~3~Pro 的高级工具使用到 Qwen3.5 的自主 agent 能力，
AI 正在从「助手」演进为「同事」。
