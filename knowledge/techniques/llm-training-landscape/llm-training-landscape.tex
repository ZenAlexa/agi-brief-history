...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north west, white!80,
    ...
    {LLM Observatory\\[1pt]Technical Reference};
  ...
  \node[anchor=north west, coverTitle,
        font=\fontsize{30}{37}\coversans\bfseries\selectfont,
        text width=9cm]
    at ([xshift=68mm, yshift=-44mm]current page.north west)
    {The Complete\\Journey of\\LLM Training};
...
\input{chapters/ch15-agent-wars}
