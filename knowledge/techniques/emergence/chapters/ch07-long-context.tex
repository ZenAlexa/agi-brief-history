...
Claude Opus 4.6 / Sonnet 4.6 & 1M tokens (GA) & 未公开 & 2026.03 \\
Claude Sonnet 4.5 / Opus 4.5 & 200K--1M tokens & 未公开 & 2025--2026 \\
GPT-5 系列        & 400K tokens & 未公开       & 2025--2026 \\
DeepSeek-V4 (Pro/Flash) & 1M tokens & CSA+HCA+SWA + MLA & 2026.04 \\
DeepSeek-V3.2-Exp & 128K tokens & DSA (Lightning Indexer) + MLA & 2025.09 \\
...
Anthropic 于 2026 年 3 月 13 日把 Claude Opus 4.6 / Sonnet 4.6 的 1M context
正式 GA，同时\textbf{取消 long-context premium}~\cite{anthropic2026context1m}。
DeepSeek 于 2026 年 4 月 24 日发布 V4-Pro/V4-Flash~\cite{deepseekv4}，
通过 CSA + HCA + SWA 三层混合注意力把 1M 上下文做成默认配置：
相比 V3.2 的 128K，V4 在 1M 上 per-token 推理 FLOPs $-73\%$、
KV cache $-90\%$，
是首个把"1M 上下文 = 经济默认"落地的开源旗舰。
