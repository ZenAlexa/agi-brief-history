...
arXiv:2604.13371~\cite{reasoningcollapse2604}
...
\cite{vjepa21_2603}（arXiv:2603.14482，3 月 17 日）
推进了四个关键设计：
（1）masking-based dense prediction loss；
（2）全 token 监督；
（3）Deep Self-Supervision；
（4）模态特定容量。
模型规模从 ViT-B 到 ViT-G/16，
参数量覆盖 1B--2B 系列。
SOTA 体现在长时间物体交互预测：
在 EpicKitchens 长时段 anticipation 上
达到 Recall@5 \textbf{40.8}。
LeCun 仍出现在共同作者列表中，
...
arXiv:2604.21454~\cite{olmo3primitives2604}
首次在受控实验中
